          ...
          <div class="container">
            <div class="features-bar-inner flex space-between">
              ...
              <div class="features-box-icon flex no-wrap">
                <img
                  src="../../assets/img/feature-icon01.png"
                  alt="cup-icon"
                  class="img-responsive self-center"
                >
              ...
              <!-- end .feature-box-icon -->
              <div class="features-box-icon flex no-wrap">
                <img
                  src="../../assets/img/feature-icon02.png"
                  alt="cup-icon"
                  class="img-responsive self-center"
                >
                <div class="content self-center">
              ...
              <div class="user-profile-icon self-center">
                <img
                  src="../../assets/img/profile-icon01.png"
                  alt="profile-icon"
                  class="img-responsive self-center"
                >
              </div>
...
<script>
import JobList from "@/views/JobList/index.vue";
export default {
  name: "home",
  data() {
    return {};
